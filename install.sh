#!/bin/sh
# install.sh — install attest from GitHub.
#
#   curl -fsSL https://raw.githubusercontent.com/srivtx/attest/main/install.sh | sh
#
# Installs the `attest` binary globally with Bun. Pass a git ref as the
# first argument to pin a branch, tag, or commit:
#
#   curl -fsSL https://raw.githubusercontent.com/srivtx/attest/main/install.sh | sh -s v0.1.0
set -eu
